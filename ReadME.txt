...
6. Every time you access an API it will show number of clicks left i.e. ( no of times the you can access the API in given time span) and time remaining(which is the refresh time)
